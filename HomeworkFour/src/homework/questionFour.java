...
//Navigate to the following link: http://automationpractice.com/index.php
//Go to the footer, see the links under Information. Create a script to click all the links.
//Click all the links one by one, starts with Specials and ends with Sitemap. 
//For each link: Click on a link, it will navigate to the new page, read the title and URL of the new page, print it in the console. Then come back to the home page and click another link. 
